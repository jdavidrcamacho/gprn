...
class oldKeplerian(MeanModel):
    ...
    def __init__(self, P, K, e, w, T0):
        ...
        self.P, self.K, self.e, self.w, self.T0 = P, K, e, w, T0
...
class corot7Keplerian(MeanModel):
    ...
    def __init__(self, P1, K1, e1, w1, phi1, P2, K2, e2, w2, phi2, sys_vel):
        super(corot7Keplerian, self).__init__(P1, K1, e1, w1, phi1,
                                              P2, K2, e2, w2, phi2,
                                              sys_vel)
        self.P1, self.K1, self.e1, self.w1, self.phi1 = P1, K1, e1, w1, phi1
        self.P2, self.K2, self.e2, self.w2, self.phi2 = P2, K2, e2, w2, phi2
        self.sys_vel = sys_vel

    @array_input
    def __call__(self, t):
        P1, K1, e1, w1, phi1, P2, K2, e2, w2, phi2, sys_vel = self.pars
